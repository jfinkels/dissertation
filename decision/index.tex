...
\lettrine{I}{n this chapter} we provide some initial structural complexity results for classes of probabilistically checkable proof systems (PCPs) for nondeterministic $\NC$ ($\NNC$) circuit families, as a first step towards characterizing probabilistic proof systems for $\P$.
